            ...
            441: (t, e, i) => {
                ...
                class nt extends V {
                    _createMap() {
                        ...
                        }), this._map.on("load", this._onMapLoaded, this), this._map.on("moveend", this._onMapMoveEnd, this), this._map.attributionControl.setPrefix("<a href='https://moving.d4science.org/group/moving_storymaps' target='_blank' class='vco-knightlab-brand'><span>&#x25a0;</span> SMBVT</a>, based on <a href='https://storymap.knightlab.com/' target='_blank'>StorymapJS</a>");
